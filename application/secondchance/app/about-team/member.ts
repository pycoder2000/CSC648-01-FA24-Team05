const members = [
  {
    ...
    image: 'Parth.jpg',
    position: 'Team Lead',
    bio: "Parth is a passionate Data Engineer. He loves architecting innovative solutions in the big data realm across AWS, GCP, and Kubernetes. He's quite proficient in writing SQL queries & utilizing Scala, Spark, and Python for optimal big data processing. He's currently pursuing a master's in Data Science and AI at San Francisco State University.",
  },
  {
    name: 'Nath Andre Velarde',
    image: 'Andre.jpg',
    position: 'Backend Lead',
    bio: 'Andre is a computer science student at SFSU aspiring to be a software developer. As a backend lead, he will be responsible for managing the software development, creating an efficient/high-quality system. He is skilled in C++ and Python and enjoys solving complex problems that lead to impactful results.',
  },
  {
