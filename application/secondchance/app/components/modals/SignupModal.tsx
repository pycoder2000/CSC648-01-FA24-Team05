...
const SignupModal = () => {
  ...
  const handleNextStep = () => {
    ...
    if (password1 !== password2) validationErrors.push('Passwords do not match.');
  ...
  const renderError = (error: string, index: number) => (
    <div
      key={`error_${index}`}
      className="relative mt-4 rounded border border-red-400 bg-red-50 px-4 py-3 text-red-700"
      role="alert"
    >
  ...
  const StepOneContent = (
    <>
      ...
      <input
        ...
        type="email"
        value={email}
        className="mt-4 h-[54px] w-full rounded-xl border border-gray-300 px-4"
        required
      />
      <input
      ...
      <CustomButton label="Next" onClick={handleNextStep} className="mt-4 w-full" />
    </>
  );
  ...
  const StepTwoContent = (
    <>
      <div className="mb-6">
        <label className="mb-2 block font-medium text-gray-700" htmlFor="country">
          Select Your Country
        </label>
        <Select
          id="country"
      ...
      <div className="mb-6">
        <label className="mb-2 block font-medium text-gray-700" htmlFor="state">
          Select Your State
        </label>
        <Select
          id="state"
      ...
      <div className="mb-6">
        <label className="mb-2 block font-medium text-gray-700" htmlFor="city">
          Select Your City
        </label>
        <Select
          id="city"
      ...
      <div className="mb-6">
        <label className="mb-2 block font-medium text-gray-700" htmlFor="phone">
          Phone Number
        </label>
        <input
          id="phone"
      ...
      <div className="mb-6">
        <label className="mb-2 block font-medium text-gray-700" htmlFor="birthday">
          Birthday
        </label>
        <input
          id="birthday"
      ...
      <div className="mb-6">
        <label className="mb-2 block font-medium text-gray-700" htmlFor="profile_picture">
        ...
        <div className="flex justify-center">
          <input
            ...
            type="file"
            accept="image/*"
            className="block cursor-pointer rounded-lg border border-gray-300 bg-gray-50 text-sm text-gray-900 focus:outline-none"
